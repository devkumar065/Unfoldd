...
export default function StatsSection() {
  ...
  const stats = [
    { value: 10000, suffix: '+', label: 'Students', desc: 'building daily', icon: '🎓' },
    { value: 500, suffix: '+', label: 'Skills Verified', desc: 'officially certified', icon: '✅' },
    { value: 200, suffix: '+', label: 'Companies', desc: 'actively hiring', icon: '🏢' },
    { value: 90, suffix: ' Days', label: 'Journey', desc: 'to interview ready', icon: '🚀' },
  ]
        ...
        <div ref={ref} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="text-5xl mb-6 group-hover:scale-110 transition-transform duration-500 transform-origin-center">
                {stat.icon}
              </div>
